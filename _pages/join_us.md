...
- **Mathematical Software Development**: Contributing to open-source tools like [Catalyst.jl](https://github.com/SciML/Catalyst.jl) for chemical reaction network modeling and [JumpProcesses.jl](https://github.com/SciML/JumpProcesses.jl) jump process numerical solvers
...
Application deadlines and requirements can be found on the [Boston University Mathematics and Statistics graduate admissions page](https://www.bu.edu/cas/academics/graduate-education/apply/mathematics-statistics/). 
